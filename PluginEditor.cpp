...
//==============================================================================
ResponseCurveComponent::ResponseCurveComponent(FormantFilterProcessor& p) :
audioProcessor(p),
...
//==============================================================================
FormantFilterProcessorEditor::FormantFilterProcessorEditor (FormantFilterProcessor& p)
...
analyzerEnabledButtonAttachment(audioProcessor.apvts, "Analyzer Enabled", analyzerEnabledButton)
{
    ...
    auto safePtr = juce::Component::SafePointer<FormantFilterProcessorEditor>(this);
...
FormantFilterProcessorEditor::~FormantFilterProcessorEditor()
{
...
//==============================================================================
void FormantFilterProcessorEditor::paint(juce::Graphics &g)
{
    using namespace juce;
...
void FormantFilterProcessorEditor::resized()
{
    auto bounds = getLocalBounds();
    bounds.removeFromTop(4);
...
std::vector<juce::Component*> FormantFilterProcessorEditor::getComps()
{
    return
    {
        &peakFreqSlider,
